...
export function buildDRE(saidas: Transaction[], entradas: Transaction[]): DREResult {
  ...
  const lines: DRELine[] = [
    ...
    { linha: 8,  descricao: '(-) Despesas de Vendas, Gerais e Administrativas (SG&A)', sinal: '-', rowStyle: 'despesa',  total: totTxs(grpSGA),            months: mL8,  groups: groupBySubcat(grpSGA),        transactions: grpSGA,        expandable: grpSGA.length > 0 },
    ...
    { linha: 13, descricao: '(-) Despesas de Capital (CAPEX)',          sinal: '-',  rowStyle: 'despesa',   total: totTxs(grpCAPEX),          months: mL13, groups: groupBySubcat(grpCAPEX),     transactions: grpCAPEX,     expandable: grpCAPEX.length > 0 },
    ...
    { linha: 15, descricao: '(+) Outras Receitas',                      sinal: '+',  rowStyle: 'receita',   total: 0,                          months: mL15, groups: [],                          transactions: [],                          expandable: false },
    { linha: 16, descricao: '(-) Outras Despesas',                      sinal: '-',  rowStyle: 'despesa',   total: totTxs(grpOutrasSaidas),    months: mL16, groups: groupBySubcat(grpOutrasSaidas), transactions: grpOutrasSaidas, expandable: grpOutrasSaidas.length > 0 },
